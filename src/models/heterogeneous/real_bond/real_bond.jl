...
description(m::RealBond) = "RealBond, $(m.subspec)"

"""
`init_model_indices!(m::RealBond)`

Arguments:
`m:: RealBond`: a model object

Description:
Initializes indices for all of `m`'s states, shocks, and equilibrium conditions.
"""
function init_model_indices!(m::RealBond)
    # Endogenous states
...
those).
"""
function init_parameters!(m::RealBond)
    # Initialize parameters
...
"""
```
init_grids!(m::RealBond)
```
"""
function init_grids!(m::RealBond)
...
function model_settings!(m::RealBond)
    default_settings!(m)
